...
**Input**: Design documents from `/specs/003-discord-nexusbot/`
...
- [x] T012 [US2] Document configuration + allowlist usage in `specs/003-discord-nexusbot/contracts/discord-commands.md` and `specs/003-discord-nexusbot/quickstart.md`
...
- [x] T016 [P] Update `README.md` to match `specs/003-discord-nexusbot/quickstart.md`
...
- [x] T018 Add role allowlist config support in `src/services/config.js` and document it in `config.json.example`, `specs/003-discord-nexusbot/contracts/discord-commands.md`, `specs/003-discord-nexusbot/quickstart.md`, `README.md`
...
- [x] T024 Add a metrics helper script in `scripts/metrics.js` and document usage in `README.md` / `specs/003-discord-nexusbot/quickstart.md`
...
- [x] T027 Document rejection/reconnect configuration in `config.json.example`, `README.md`, `specs/003-discord-nexusbot/quickstart.md`, `specs/003-discord-nexusbot/contracts/discord-commands.md`
...
- [x] T030 Add important keyword memory capture in `src/index.js`, `src/services/memoryStore.js`, `src/services/config.js` and document it in `config.json.example`, `README.md`, `specs/003-discord-nexusbot/quickstart.md`, `specs/003-discord-nexusbot/contracts/discord-commands.md`
- [x] T031 Add auto-reply mode for non-prefixed messages in `src/index.js`, `src/services/config.js`, `src/services/discordClient.js` and document it in `config.json.example`, `README.md`, `specs/003-discord-nexusbot/quickstart.md`, `specs/003-discord-nexusbot/contracts/discord-commands.md`
